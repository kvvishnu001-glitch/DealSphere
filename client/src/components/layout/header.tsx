      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          <Link href="/" className="flex items-center space-x-2 flex-shrink-0">
            <Percent className="text-red-600 w-5 h-5 sm:w-6 sm:h-6" />
            <span className="text-lg sm:text-xl font-bold text-gray-900">DealSphere</span>
          </Link>

          {children && (
            <div className="flex-1 mx-3 sm:mx-6 max-w-lg hidden sm:block">
              {children}
            </div>
          )}
